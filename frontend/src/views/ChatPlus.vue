      ...
      <el-main v-loading="loading" element-loading-background="rgba(122, 122, 122, 0.3)">
        <div class="chat-head">
          <div class="chat-config">
            ...
            <el-button type="success" @click="changeVoice" plain>
              <el-image :src="musicIcon" class="musicIcon"></el-image>
              <span @click="changeVoice">音乐</span>
            </el-button>
          </div>
        </div>
            ...
            <div id="container">
              ...
              <div class="re-generate">
                <div class="btn-box">
                  ...
                  <button class="button" @click="onSatisfiedClick" v-show="showSetify">满意</button>
                  <button class="button" @click="onUnsatisfiedClick" v-show="showSetify">不满意</button>
...
const showSetify = ref(false)
const musicIcon = ref("/images/音符.png")
const myIp = ref("")
...
const onSatisfiedClick = function() {
      // 处理满意按钮点击事件
      console.log("满意按钮被点击");
      // 您可以在这里添加其他逻辑，例如向服务器发送请求或更新数据
      showSetify.value = false
      alert("谢谢您的回复，我们会继续保持")
      
    };
    const onUnsatisfiedClick = function() {
      // 处理不满意按钮点击事件
      console.log("不满意按钮被点击");
      // 您可以在这里添加其他逻辑，例如向服务器发送请求或更新数据
      showSetify.value = false
      alert("很遗憾收到您的回复，我们会不断改进")
    };
    ...
    try {
      if (event.data instanceof Blob) {
        ...
        reader.onload = () => {
          ...
          console.log("这里是向token请求", prompt.value)
...
const sendMessage = function () {
  ...
  console.log("我现在是在发消息 "+prompt.value)
  // 追加消息
  chatData.value.push({
    type: "prompt",
    id: randString(32),
...
.button {
  margin: 0 10px;
  padding: 10px 20px;
  background-color: #4CAF50; /* 满意按钮颜色 */
  color: white;
  border: none;
  border-radius: 5px;
  cursor: pointer;
...
.button.unsatisfied {
  background-color: #f44336; /* 不满意按钮颜色 */
}

.button.unsatisfied:hover {
